### This code has been inspired from https://www.tensorflow.org/text/tutorials/transformer
### This is official implementation of Transformer, modified according to our project needs.
